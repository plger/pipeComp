...
We found the `meanAbsCorr` with the covariate to be particularly informative, and therefore designed the plotting wrapper around it. It can be used simply by specifying the desired covariate:
