...
We also assume three datasets in `SingleCellExperiment` (SCE) format (not included in the package - see the last section of this vignette) and run the pipeline:
